...
WORKDIR /CG2223-Hosted/frontend
...
WORKDIR /
COPY --from=frontend-build /CG2223-Hosted/frontend/dist frontend/dist
COPY --from=backend-build /CG2223-Hosted/backend/target/swagger-spring-1.0.0.jar .
EXPOSE 8080
